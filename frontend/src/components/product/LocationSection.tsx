...
function LocationSection({
  ...
  const handleSaveNewAddr = () => {
    ...
    setSavingAddr(true);
    void onAddressCreated(newAddr).then(() => {
    ...
    <section className="rounded-xl border border-border-main bg-white p-6">
      ...
      <div className="flex flex-col gap-5">
          ...
          >
            ...
            {addresses.map((a) => (
              <option key={a.address_id} value={a.address_id}>
                {a.street} {a.number}{a.floor ? `, ${a.floor}` : ""} — {a.city}
              </option>
            ))}
          </select>
        ...
        {!showNewForm ? (
          <button
            type="button"
            className="flex w-fit items-center gap-1.5 text-[13px] font-medium text-brand-primary hover:underline"
          ...
          <div className="rounded-lg border border-border-main bg-surface p-4">
            <div className="mb-3 flex items-center justify-between">
              <p className="text-[13px] font-semibold text-ink">Añadir dirección</p>
              <button
                type="button"
                onClick={() => { setShowNewForm(false); setNewAddrErrors({}); }}
            ...
            <div className="grid grid-cols-[1fr_auto] gap-3">
              ...
              <div className="col-span-2 grid grid-cols-[1fr_100px] gap-3">
                <div>
                  <label htmlFor="new-street" className="text-[12px]">Calle / Avenida</label>
                  <input
                    id="new-street"
                    name="street"
                    type="text"
                ...
                <div>
                  <label htmlFor="new-number" className="text-[12px]">Número</label>
                  <input
                    id="new-number"
                    name="number"
                    type="text"
              ...
              {/* Floor (optional) */}
              <div>
                <label htmlFor="new-floor" className="text-[12px]">Piso / Puerta <span className="text-subtle">(opcional)</span></label>
                <input
                  id="new-floor"
                  name="floor"
                  type="text"
              ...
              {/* Postal code */}
              <div>
                <label htmlFor="new-postal" className="text-[12px]">Código postal</label>
                <input
                  id="new-postal"
                  name="postal_code"
                  type="text"
                ...
                />
                {newAddrErrors.postal_code && <p className="mt-0.5 text-xs text-red-500">{newAddrErrors.postal_code}</p>}
              </div>

              {/* City */}
              <div>
                <label htmlFor="new-city" className="text-[12px]">Ciudad</label>
                <input
                  id="new-city"
                  name="city"
                  type="text"
              ...
              {/* Province */}
              <div>
                <label htmlFor="new-province" className="text-[12px]">Provincia</label>
                <input
                  id="new-province"
                  name="province"
                  type="text"
        ...
        <div className="rounded-lg border border-border-main p-4">
          <p className="mb-3 text-[13px] font-medium text-ink">Disponibilidad</p>
          <div className="grid grid-cols-2 gap-4">
            <label className="flex cursor-pointer items-start gap-3">
              ...
              />
              <div>
                <p className="text-[13px] font-medium text-ink">Disponible ahora</p>
            ...
            <label className="flex cursor-pointer items-start gap-3">
              ...
              />
              <div>
                <p className="text-[13px] font-medium text-ink">Bloquear fechas</p>
